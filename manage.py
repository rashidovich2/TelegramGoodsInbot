...
def banner():
    ...
    print(r+'  Версия: 1.0 |  Автор: Rashidovich'+n+'\n')
...
while True:
    ...
    banner()
    print(r+'[] Аккаунты'+n)
    print(cy+'[1] Добавить новые аккаунты'+n)
    print(cy+'[2] Удалить все аккаунты в бане'+n)
    print(cy+'[3] Показать список всех аккаунтов'+n)
    print(cy+'[4] Удалить конкретный аккаунт'+n)
    print(cy+'[5] Перевести аккаунты из Создан в Доступен'+n)
    print(cy+'[6] Перевести аккаунт из Ожидает в Доступен'+n)
    print(cy+'[7] Перевести аккаунт в Ожидает'+n)
    print(cy+'[8] Перевести аккаунт в Забанен'+n)
    print(r+'[] Парсинг и загрузка в БД'+n)
    print(cy+'[9] Загрузить контакты из гео в БД'+n)
    print(cy+'[10] Cпарсить группу и загрузить контакты в БД'+n)
    print(cy+'[11] Статистика БД аккаунтов'+n)
    print(r+'[] Инвайт участников из БД'+n)
    print(cy+'[12] Инвайт из групп в группу'+n)
    print(cy+'[13] Инвайт по гео в группу'+n)
    print(r+'[] Рассылка сообщений'+n)
    print(cy+'[14] Рассылка сообщений'+n)
    #print(lg+'[5] Update your Genisys'+n)
    print(r+'[] Прогрев аккаунтов 20 минут'+n)
    print(cy+'[15] Прогрев акаунтов'+n)
    print(cy+'[99] Настройки')
    print(cy+'[16] Выход')
    ...
    if a == 1:
        ...
        if len(accounts) == 0:
            print(r+'[!] У Вас нет аккаунтов! Пожалуйста добавьте и повторите еще раз')
            sleep(3)
        else:
        ...
        #j.close()
        print(f'\n{cy}')
        print(f' #     |   API ID  |     Номер телефона  |    Статус   |    Приглашено24  |  Время старта')
        print(f'================================================================================================================')
        i = 0
        for z in j:
        ...
        print(f'\n{cy}')
        print(f'Источник |   Группа  |  Статус  |  Количество  | ')
        print(f'=============================================================================================================')
        i = 0
        for z in j:
