...
#client = Client("mg0ar8cmmSvzG3JJFA3JRRGXkhXcTw7LaDBsiyGdIJ6C82egeCfP6PhEiHB4WWSL", "E3QcetI7PWCdSDNNHGTc60GwJAoMRHsHZaCkxTS1qW3pKE9NzznmUPQ5Sz8U4lE")
...
api_key="F7MfpZfoU0UIL3k727TnN6lHJi5YeWFN7sFHjxpOIZCyFOB64AK1FZ52JWoMx5qU"
api_secret="BuIH3vQpUXZoIDadDKUjNpI15QATtT1ewesUY9p644dF6BWF592rHqfzNGZNrW3h"


# Апи работы с YooMoney
class BinanceAPI(AsyncClass):
    async def __ainit__(self, api_key=api_key, api_secret=api_secret):
        self.client = Spot(api_key='0dPZSBNZt50jG1OsZw8Ihaavt5XHndsEmOarTBh0u6Kxn03ViuhSeLr9rwenMcyP', api_secret='07FmZzO40IJ4fWJkcvOMyS99hJJgRLBhOGvgMRuZcuS6f6zOWK6pGCAdYVmJnYER')
        self.address = client.deposit_address(coin='USDT', network='TRX', recvWindow=5000)
        '''self.suser_id = 919148970
        self.api_key = get_upaymentx(self.suser_id)['api_key']
        ...
        #address = client.deposit_address(coin='USDT', network='TRX', recvWindow=5000)

        #print(address)
        #aadr = address['address']
        #print(client.time())
    ...
    async def bill_pay(self, get_amount, get_way, get_coin):
        '''if get_coin == "BTC": crypto_addr = "0x9798e988664856c20c37b5bf311a4ee85227a0df"
        if get_coin == "USDT": crypto_addr = "0x9798e988664856c20c37b5bf311a4ee85227a0df"
        if get_coin == "ETH": crypto_addr = "0x9798e988664856c20c37b5bf311a4ee85227a0df"
        if get_coin == "USDC": crypto_addr = "0x9798e988664856c20c37b5bf311a4ee85227a0df"'''
